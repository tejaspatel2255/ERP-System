            ...
            <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    ...
                    <Input
                        ...
                        required
                        style={{
                            borderColor: (formData.retypePassword && formData.password !== formData.retypePassword) ? 'var(--error)' : 'var(--border)'
                        }}
                    />
                </div>
                ...
                <div style={{
                    ...
                    <ul style={{ listStyle: 'none', paddingLeft: 0, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.25rem' }}>
