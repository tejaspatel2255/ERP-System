    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.875rem', fontWeight: 800, color: 'var(--text-main)', letterSpacing: '-0.025em' }}>System Configuration</h1>
                    <p style={{ color: 'var(--text-muted)', marginTop: '0.25rem' }}>Manage global system settings and preferences.</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={saving}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: '2rem', alignItems: 'start' }}>
                ...
                <div style={{ minHeight: '500px' }}>
                    ...
                    {activeTab === 'general' && (
                        <div className="card">
                            <h2 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem', paddingBottom: '1rem', borderBottom: '1px solid var(--border)' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                                ...
                                <div style={{ gridColumn: 'span 2' }}>
                                    ...
                                    <div style={{ border: '2px dashed var(--border)', borderRadius: '0.5rem', padding: '3rem', textAlign: 'center', color: 'var(--text-muted)', cursor: 'not-allowed', backgroundColor: '#F9FAFB', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
                                        <div style={{ padding: '0.75rem', background: '#EEF2FF', borderRadius: '50%', color: 'var(--primary)' }}>
                                            <Upload size={24} />
                                        </div>
                                ...
                                <div style={{ marginBottom: '2rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
                                        <div>
                                            ...
                                            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Define complexity requirements for user passwords.</p>
                                        </div>
                                        <div style={{ background: '#E0E7FF', color: 'var(--primary)', fontSize: '0.75rem', padding: '0.25rem 0.5rem', borderRadius: '4px', fontWeight: 600 }}>COMING SOON</div>
                                    </div>
                                ...
                                <div style={{ paddingTop: '2rem', borderTop: '1px solid var(--border)' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                                        <div>
                                            ...
                                            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Control user session duration and timeouts.</p>
                                        </div>
                                    </div>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem', border: '1px solid var(--border)', borderRadius: '0.5rem', background: '#F9FAFB' }}>
                                        <input type="checkbox" checked readOnly style={{ width: '1.2rem', height: '1.2rem' }} />
                                        <div>
                                            <p style={{ fontWeight: 500 }}>Enforce session timeout</p>
                                            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Automatically log out users after 30 minutes of inactivity.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    {['notifications', 'modules', 'data', 'logs'].includes(activeTab) && (
                        <div className="card" style={{ padding: '4rem', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '400px' }}>
                            <div style={{
                                width: '5rem', height: '5rem', background: '#F3F4F6', borderRadius: '50%',
                            ...
                            <p style={{ color: 'var(--text-muted)', maxWidth: '450px', lineHeight: '1.6' }}>
                                The <strong>{tabs.find(t => t.id === activeTab)?.label}</strong> module is currently under development.
                                We are preparing the backend infrastructure to support this feature in the upcoming release.
                            </p>
                            <div style={{ marginTop: '2.5rem' }}>
                                <button className="btn-secondary" onClick={() => setActiveTab('general')}>Return to General Settings</button>
                            </div>
                        </div>
                    )}
                </div>
