                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2rem' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                        <p style={{ margin: '0 0 0.5rem' }}>
                            <strong>Manifest #:</strong> {manifestNumber}
                        </p>
                        <p style={{ margin: '0 0 0.5rem' }}>
                            <strong>Date:</strong> {new Date(dispatchDate).toLocaleDateString()}
                        </p>
                        <p style={{ margin: 0 }}>
                            <strong>Ref Order:</strong> #{order._id.slice(-6).toUpperCase()}
                        </p>
                    </div>
                </div>
