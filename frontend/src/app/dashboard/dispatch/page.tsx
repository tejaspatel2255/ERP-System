...
export default function DispatchPage() {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            case 'Delivered':
                return { bg: '#ECFDF5', text: '#059669', icon: <CheckCircle size={14} /> };
            case 'In Transit':
                return { bg: '#EFF6FF', text: '#2563EB', icon: <Truck size={14} /> };
            default:
                return { bg: '#F3F4F6', text: '#4B5563', icon: <Clock size={14} /> };
        }
    };
            ...
            >
                <div>
                    ...
                    <p style={{ color: 'var(--text-muted)', marginTop: '0.25rem' }}>
                        Track shipments and delivery logs.
                    </p>
                </div>
                <Link
                            ...
                            >
                                <div>
                                    ...
                                    <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                                        Order ID: {dispatch.order?._id?.slice(-6).toUpperCase()}
                                    </p>
                                </div>
                                <span
                                    style={{
