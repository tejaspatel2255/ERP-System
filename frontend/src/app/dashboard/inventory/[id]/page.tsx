...
export default function ProductDetailsPage() {
    ...
    return (
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div
                style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '2rem' }}
            >
                {/* Product Stats */}
                <div
                    style={{
                ...
                >
                    ...
                    <div
                        style={{
                            fontSize: '0.875rem',
                            color: product.stock <= (product.minLevel || 10) ? 'var(--error)' : 'var(--success)',
                        }}
                    >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                            <div>
                                ...
                                <div style={{ fontSize: '1.5rem', fontWeight: 700 }}>
                                    {forecast.predictedNextMonth} units
                                </div>
                            </div>
                            <div style={{ borderLeft: '1px solid var(--border)', paddingLeft: '2rem' }}>
                                ...
                                <div
                                    style={{
                                        fontSize: '1.125rem',
                                        fontWeight: 600,
                                        color: forecast.recommendation.includes('Critical')
                                            ? 'var(--error)'
                                            : 'var(--success)',
                                    }}
                                >
