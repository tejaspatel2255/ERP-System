...
import { StoreLedger } from 'shared';
                    ...
                    <tbody>
                        {ledger.length === 0 ? (
                            ...
                            ledger.map((entry) => (
                                <tr
                                    key={entry._id}
                                    style={{ borderBottom: '1px solid var(--border)', fontSize: '0.9rem' }}
                                >
                                    <td style={{ padding: '1rem' }}>{new Date(entry.date).toLocaleString()}</td>
                                    ...
                                    <td style={{ padding: '1rem', color: 'var(--text-muted)' }}>{entry.remarks}</td>
                                </tr>
                            ))
                        )}
                    </tbody>
