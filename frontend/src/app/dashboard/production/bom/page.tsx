...
import { BOM, Product } from 'shared';
...
export default function BOMPage() {
    ...
    const [materials, setMaterials] = useState<{ material: string; quantity: number }[]>([
        { material: '', quantity: 1 },
    ]);
    ...
    const fetchData = async () => {
        try {
            const [bomsData, productsData] = await Promise.all([ProductionService.getBOMs(), ProductService.getAll()]);
            setBoms(bomsData);
            ...
            >
                <div>
                    ...
                    <p style={{ color: 'var(--text-muted)', marginTop: '0.25rem' }}>
                        Manage product recipes and compositions.
                    </p>
                </div>
                <button
                        ...
                        >
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                                <Input
                                    ...
                                    required
                                    placeholder="e.g. Standard Table Recipe"
                                />
                                <div>
                                    <label
                                        style={{
