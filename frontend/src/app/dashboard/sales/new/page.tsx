...
import { Customer, Product, SaleItem } from 'shared';
...
export default function NewSalePage() {
    ...
    const addToCart = () => {
        ...
        if (existing) {
            ...
            setCart([
                ...cart,
                { product, name: product.name, quantity: 1, price: product.price, total: product.price },
            ]);
        }
    };
    ...
    const updateQuantity = (productId: string, qty: number) => {
        ...
        setCart(
            cart.map((item) =>
                item.product._id === productId ? { ...item, quantity: qty, total: qty * item.price } : item
            )
        );
    };
                    ...
                    <div style={{ borderTop: '2px solid var(--border)', paddingTop: '1rem' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                border: 'none',
                                background:
                                    cart.length === 0 || !selectedCustomer ? 'var(--text-muted)' : 'var(--primary)',
                                color: 'white',
                                fontWeight: 700,
                                fontSize: '1rem',
                                cursor: 'pointer',
